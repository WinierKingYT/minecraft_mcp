...
| `permission.attach` | V1.1 | mutation | disposable_runtime | runtime_discard | none | **R2** | — | `permission_attach` |
| `permission.check` | V1.1 | read | disposable_runtime | reversible | none | **R0** | `permission_check` | — |
...
| `pool.acquire` | V1.1 | mutation | disposable_runtime | runtime_discard | none | **R2** | — | `pool_acquire` |
| `pool.evict` | V1.1 | delete | disposable_runtime | destructive | none | **R4** | — | — |
| `pool.list` | V1.1 | read | disposable_runtime | reversible | none | **R0** | `pool_list` | — |
| `pool.release` | V1.1 | mutation | disposable_runtime | runtime_discard | none | **R2** | — | `pool_release` |
| `pool.reset` | V1.1 | delete | disposable_runtime | destructive | none | **R4** | — | — |
| `pool.status` | V1.1 | read | disposable_runtime | reversible | none | **R0** | `pool_status` | — |
