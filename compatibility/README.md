...
| `maven.version`, `maven.distribution.sha256`, `maven.wrapper.jar_sha256` | `repo.maven.apache.org` maven2 koordinatı (bin.zip + maven-wrapper JAR indirilir; SHA-256 canlı karşılaştırılır, `--verify-jar`) |
