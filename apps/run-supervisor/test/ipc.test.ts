...
function stubHandlers(overrides: Partial<Record<IpcMethod, MethodHandler>> = {}): Record<IpcMethod, MethodHandler> {
  const base: Record<IpcMethod, MethodHandler> = {
    ...
    'project.validate': async () => ({ projectId: 'test', findings: [], buildSystem: 'gradle', gradleVersion: null, mavenVersion: null, javaMajor: null, distributionSha256Valid: null, lockFilePresent: false, verificationMetadataPresent: false }),
    ...
    'profile.get': async () => ({ id: 'paper-26.2-build-84-v1', status: 'active', minecraftVersion: '26.2', paperBuild: 84, verificationStatus: 'verified', javaVersion: 25, nodeVersion: '24.18.1', gradleVersion: '9.6.1', mavenVersion: '3.9.16' }),
